            ...
            @include('frontend_view.layouts.breadcrumb_nav')
                ...
                <section class="site-section-hero bg-image bg-header-image" data-stellar-background-ratio="0.5" id="section-home">
                  <div class="row justify-content-center align-items-center">
                      <div class="col-md-10">
                            <h1 class="heading filterpapercolor bold-text" data-aos="fade-right"> Filter Paper</h1>
                    ...
                    <div class="container">
                      <div class="row justify-content-center">
                        ...
                        <div class="col-md-12 text-center general-text-color">
                          <h3>Our Range of</h3>
                          <h2 class="heading">Filter Paper</h2>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col padding-top-bot-40">
                              <a href="{{  url('frontend/filteration/filter-paper/qualitative') }}">
                                ...
                                <label class="text-uppercase margin-top-10 font-weight-500">Qualitative</label>
                              </a>
                            </div>
                            <div class="col padding-top-bot-40">
                ...
                <section class="site-section grey_background" id="section-contact">
                  <div class="container">
                    <div class="row justify-content-center">
