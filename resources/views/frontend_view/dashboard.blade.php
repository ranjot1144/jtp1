                        ...
                        ?>
                          ...
                          <!--<div class="col-md-4 col-lg-4 mb-4">
                              ...
                              <div class="image_hover">
                                  ...
                                  <div class="text">
                                      <p class="mb-5">For Anaysis of all types <br/>of water sample</p>
                          ...
                          <div class="col-md-4 col-lg-4 mb-4" style="padding-right:15px;">
                            <div class="image_hover">
                                <a href="{{ URL('/product/industries') }}">
                                  ...
                                  <div class="text " style="width:100%; top: 60%; text-align:center;">
                                    <p class="mb-5 text-white">For Anaysis of all types <br/>of water sample</p>
                                    <a href="{{ URL($range_data[$i]->range_url) }}" class="btn btn-primary btn-md themebackgroundColor">Explore</a>
                                  </div>
                                  <div class="overlay"></div>
                                </a>
