    ...
    <body>
        <small style="float: right; font-size:0.5em;">DOC 025 ISS 4</small>
            ...
            <footer>
                ...
                <div style="width:22%; padding:1em;">
                ...
                <div style="position:relative; padding-left: 1em;">
                    {{-- Have to put the directory to the live..  --}}
                    <img class="iso13485" src="{{ public_path().'/assets/images/iso/iso13485.jpg'}}" style="width:7em;"  alt="iso13485">
                    <img class="iso9001" src="{{ public_path().'/assets/images/iso/iso9001.jpg'}}" style="width:7em;"  alt="iso9001">
                </div>
            </footer>
